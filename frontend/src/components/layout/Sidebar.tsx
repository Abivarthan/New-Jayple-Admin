...
export const Sidebar: React.FC = () => {
  ...
  const menuItems: SidebarItem[] = [
    ...
    { name: 'Booking Monitor', path: '/booking-monitor', icon: Calendar },
    { name: 'Auto-Accepted', path: '/auto-accepted', icon: Calendar },
    { name: 'Delayed Services', path: '/delayed-services', icon: Calendar },
    { name: 'Call Workflow', path: '/call-workflow', icon: Calendar },
    { name: 'Fraud Flags', path: '/fraud-flags', icon: ShieldAlert },
    { name: 'Settlements', path: '/settlements', icon: IndianRupee, permission: 'settlements' },
    { name: 'Refund Cases', path: '/refund-cases', icon: IndianRupee, permission: 'settlements' },

...
const Transactions: React.FC = () => (
  <div className="space-y-6">
    <div>
      ...
      <p className="text-sm text-slate-400 mt-1">All payment transactions across the platform.</p>
    </div>
    <div className="p-8 bg-slate-800/60 rounded-2xl border border-slate-700 flex flex-col items-center gap-4">
      ...
      <div className="text-center">
        <p className="text-slate-300 font-semibold">Transaction Ledger</p>
        <p className="text-slate-500 text-sm mt-2">Platform-wide payment transaction history with filtering and export. Coming soon.</p>
      </div>
    </div>
  </div>
);

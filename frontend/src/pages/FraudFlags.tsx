  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-gray-900">Fraud Flags</h1>
          <p className="text-sm text-gray-500">Vendors whose bookings this week are <b>more than 50%</b> last-minute cancellations
      ...
      {rows.length === 0 ? (
        ...
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {rows.map((r) => (
              <div key={r.vendorId} className="rounded-xl border border-rose-500/30 bg-white p-5">
                ...
                <div className="text-xs text-gray-500">
                  ...
                  <b className="text-gray-900">{r.totalBookings}</b> bookings this week
                </div>
                ...
                <div className="text-[10px] text-gray-500 mt-2 select-all">UID: {r.vendorId}</div>
              </div>
            ))}
          </div>
        </>

    ...
    <div className="flex min-h-screen w-screen items-center justify-center bg-gray-50 px-4 text-gray-900">
      <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-500">Sign in to manage operations</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={loading}
                className="w-full rounded-lg border border-gray-200 bg-gray-50 py-2.5 pl-10 pr-4 text-gray-900 placeholder-slate-500 outline-none transition-all focus:border-black focus:ring-1 focus:ring-violet-500 disabled:opacity-50"
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full items-center justify-center rounded-lg bg-black text-white py-3 text-sm font-semibold text-gray-900 transition-all hover:bg-gray-900 active:bg-violet-700 disabled:opacity-50 disabled:hover:bg-black text-white"
          >
            {loading ? (
        ...
        <button
          ...
          disabled={loading}
          className="mt-4 flex w-full items-center justify-center rounded-lg border border-gray-200 bg-slate-700 py-2 text-xs font-semibold text-gray-800 transition-all hover:bg-gray-100 active:bg-white disabled:opacity-50"
        >
